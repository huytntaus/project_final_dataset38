---
title: 'EEMB 146 Final Report: Down to the Root: Digging into Soil pH and Moisture
...
Grasslands are critical ecosystems that provide habitat, support biodiversity, and regulate essential ecological processes such as nutrient cycling and soil health (Fitter et al., 2005; Smith et al., 2008). However, human land-use practices like grazing and mowing can significantly alter soil conditions, potentially affecting long-term ecosystem function and sustainability (Zheng et al., 2023; Wang et al., 2019). Understanding how land management influences soil chemistry—particularly soil pH—is important because pH regulates nutrient availability, shapes microbial communities, and influences plant productivity.

This project uses data from a field study conducted by Wang, Ren, Jin, and Ma (2019), published in the Dryad Digital Repository (https://doi.org/10.5061/dryad.2fqz612k9). The study was carried out in the temperate grasslands of Inner Mongolia, China, and examined how three land-use treatments—Enclosure, Grazing, and Mowing—affect soil properties. Data were collected in August 2017 and include variables such as soil pH, soil moisture (SM), and treatment type. After data cleaning, the dataset analyzed here consists of 30 observations and 5 variables.
...
Fitter, A. H., et al. “Biodiversity and ecosystem function in soil.” Functional Ecology 19.3 (2005): 369–377. https://doi.org/10.1111/j.0269-8463.2005.00969.x

Zheng, Jiahua, et al. “Effects of fencing on near-term ecosystem multifunctionality in a typical steppe in Inner Mongolia.” Agriculture, Ecosystems & Environment 342 (2023): 108238. https://doi.org/10.1016/j.agee.2022.108238

Smith, Pete, et al. “Greenhouse gas mitigation in agriculture.” Philosophical Transactions of the Royal Society B: Biological Sciences 363.1492 (2008): 789–813. https://doi.org/10.1098/rstb.2007.2184
...
Wang, D., Ren, H., Jin, Y., & Ma, M. (2019). Land use alters relationships of grassland productivity with plant and arthropod diversity in Inner Mongolian grassland. https://doi.org/10.5061/dryad.2fqz612k9
