...
Grasslands are critical ecosystems that provide habitat, support biodiversity, and regulate essential ecological processes like nutrient cycling and soil health. Human land-use practices such as grazing and mowing can alter these soil conditions, potentially impacting ecosystem function and long-term sustainability (Bardgett et al., 2001; Wang et al., 2019; Smith et al., 2008). Understanding how land management influences soil chemistry—particularly soil pH—is important because pH affects nutrient availability, microbial communities, and plant productivity.

This project uses data from a field study conducted by Wang et al. (2019), published in the Dryad Digital Repository. The study was carried out in the temperate grasslands of Inner Mongolia, China, and investigated how three land-use treatments—Enclosure, Grazing, and Mowing—affect soil properties. Data were collected in August 2017 and include variables such as soil pH, soil moisture (SM), and treatment type. After data cleaning, the dataset used here consists of 30 observations and 5 variables.
...
Wang, D., Ren, H., Jin, Y., & Ma, M. (2019). Effects of grazing and mowing on biodiversity in the Inner Mongolian steppe. Dryad Digital Repository. https://doi.org/10.5061/dryad.2fqz612k9
